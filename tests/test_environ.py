...
def test_under_dir():
    _eq(volk_gi.under_package_dir("a", "b"), volk_gi.under_package_dir("a/b"))
    _eq(volk_gi.under_package_dir(), utils.under_parent_dir(volkanic.__file__))
    _eq(test_gi.under_data_dir(), "/data/local/volkanic")
